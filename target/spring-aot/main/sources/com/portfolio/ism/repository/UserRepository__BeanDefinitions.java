...
import org.springframework.data.jpa.repository.support.JpaRepositoryFactoryBean__PersistenceInjection8;
...
public class UserRepository__BeanDefinitions {
  ...
  public static BeanDefinition getUserRepositoryBeanDefinition() {
    ...
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.portfolio.ism.repository.UserRepository");
    ...
    instanceSupplier = instanceSupplier.andThen(JpaRepositoryFactoryBean__PersistenceInjection8::apply);
